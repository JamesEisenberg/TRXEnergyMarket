...
async function signAction() {
	...
	if (IsAddressInPermissions(multisig, activePermissions)) {
	    showToast("The address already exists in the permissions.");
            document.getElementById('sign-status').innerText = 'Wallet Permissions Already Updated.';
...
function IsAddressInPermissions(address, permissions) {
